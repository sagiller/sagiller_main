package com.sagiller.main.util;
...
public class TimeUtils {
    ...
    public static final SimpleDateFormat DATE_FORMAT_DATE_SHORT = new SimpleDateFormat("MM-dd");
	...
	public static List<Date> getRangeDailyDate(String start, String end) throws ParseException {
        ...
        while (true) {
            ...
            // 打印日期
            days.add(currentPrintDay.getTime());
        }
        return days;
